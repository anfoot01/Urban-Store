...
import { fetchOnSaleProducts } from "../../../api/productsApi";
import { BtnView } from '../../UI/BtnView/BtnView';
import { CardProductSale } from "../../CardProduct/CardProductSale";
import { DataProduct, Product } from "../../../types/products";
import { CarouselArrows } from "../CarouselArrows/CarouselArrows";
import styles from "./OnSale.module.scss";

export const OnSaleContainer: React.FC = () => {
                ...
                <div className={styles.carousel} ref={carouselRef}>
                    {extendedProducts.map((product: Product, index) => (
                        <CardProductSale
                            ...
                            priceCurrent={product.currentPrice}
                        />
                    ))}
                </div>
            </div>
